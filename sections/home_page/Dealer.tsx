      ...
      <div className={s.DealerSection__first_container}>
        <div>
          ...
          <p>
            ...
            needed to go faster, we started working with carbon fiber and built our own wind tunnel,
            and after addressing the problem of Attention Deficit Disorder, we founded the
      ...
      <div className={s.DealerSection__second_container}>
        <div>
          ...
          <p>
            ...
            land. At the same time, we took part in a number of advisory councils, as a result of
            which, within 6 months, a decision was made to establish the International Mountain Bike
            Association (IMBA). We became MTB evangelists who helped riders gain access to the
            trails. It's simple: without trail protectors, there's nothing left to protect
          </p>
        </div>
